...
parser.add_argument("-r", "--custom", type=str, help="Add custom residues (comma-separated, e.g., 'ABC,UVW')")
...
prod_step = 1250000000                                           # production steps
equil_step = 10000                                              # equilibration steps
log_freq = 1250                                                 # frequency of log file
traj_freq = 25000                                # frequency of trajectory file
...
"""        
def mod(system):
    utils.crowding_effect(system, crowding_factor=1.4)
