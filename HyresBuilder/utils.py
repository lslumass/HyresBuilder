...
def load_ff(model='protein'):
    if model == 'protein':
        ...
        path1 = pkg_res.path("HyresBuilder.forcefield", "top_RNA.inp")
        path2 = pkg_res.path("HyresBuilder.forcefield", "param_RNA.inp")
    elif model == 'ATP':
        path1 = pkg_res.path("HyresBuilder.forcefield", "top_ATP.inp")
        path2 = pkg_res.path("HyresBuilder.forcefield", "param_ATP.inp")
    else:
