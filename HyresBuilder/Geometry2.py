...
class TyrGeo(Geo):
    ...
    def __init__(self):
        ...
        self.CA_CB_length = 1.86
        self.C_CA_CB_angle = 123.6
        self.N_C_CA_CB_diangle = 120.0

        self.CB_CC_length = 3.18
        self.CA_CB_CC_angle = 109.1
        self.N_CA_CB_CC_diangle = -30.00

        self.CB_CD_length = 3.18
        self.CA_CB_CD_angle = 109.1
        self.N_CA_CB_CD_diangle = -96.00

        self.CC_CE_length = 2.65
        self.CB_CC_CE_angle = 118.5
        self.CA_CB_CC_CE_diangle = -104.00
