...
metabolome = {
    ...
    'ATP': {
        'bonds': {
            ('M3', 'M2'): (50.0, 2.73),  # M01 - PHO
            ('M2', 'M1'): (65.0, 2.37),  # PHO - PHO
            ('M1', 'C1'): (50.0, 3.94),  # PHO - RS1
            ('C1', 'C3'): (200.0, 2.39),  # RS1 - M05
            ('C2', 'C3'): (100.0, 2.09),  # RS2 - M05
        },
        'angles': {
            ('M3', 'M2', 'M1'): (60.0, 158.0),  # M01 - PHO - PHO
            ('M2', 'M1', 'C1'): (10.0, 132.0),  # PHO - PHO - RS1
            ('M1', 'C1', 'C3'): (20.0, 105.5),  # PHO - RS1 - M05
            ('M1', 'C1', 'C2'): (30.0,  97.0),  # PHO - RS1 - RS2
            ('NA', 'C2', 'C3'): (15.0, 144.0),  # RA1 - RS2 - M05
        },
        'dihedrals': {
            ('M3', 'M2', 'M1', 'C1'): (1.5, 1, 176.0),
            ('M2', 'M1', 'C1', 'C2'): (0.8, 1, -61.0),
            ('M2', 'M1', 'C1', 'C3'): (0.5, 1, -8.0),
            ('M1', 'C1', 'C2', 'NA'): (11.0, 1, 132.0),
            ('M1', 'C1', 'C3', 'C2'): (24.0, 1, 92.0),
            ('C3', 'C2', 'NA', 'NB'): (4.0, 1, 103.0),
        },
        'impropers': {
            ('C1', 'M1', 'C2', 'C3'): (30.0, 0, -61.5),  # IMPH C1 M1 C2 C3
        },
    },
    'APR': {
        'bonds': {
