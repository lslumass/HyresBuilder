...
metabolome = {
    ...
    'NCA': {
        'bonds': {
            ...
            ('M1', 'M3'): (150.0, 1.95),  # P1H - A1W
            ('M2', 'M3'): (150.0, 1.95),  # A2W - A1W
            ('M3', 'M4'): (10.0, 2.47),   # A1W - M04
        },
        'angles': {
    ...
    'ADN': {
        ...
        'dihedrals': {
            ...
            ('C1', 'C2', 'NA', 'NB'): (5.0, 1, 165.0)
        },
        'impropers': {
            ('C1', 'M1', 'C2', 'C3'): (4.5, 0, -60.4),
        },
    },
    'MTA': {
        'bonds': {
            ('M1', 'C1'): (50.0, 4.05),  # P1C - RS1
            ('C1', 'C3'): (150.0, 2.36), # RS1 - M05
            ('C2', 'C3'): ( 70.0, 2.11), # RS2 - M05
        },
        'angles': {
    ...
    'NAD': {
        'bonds': {
            ('M2', 'M1'): (50.0, 2.59),  # PHO(M2) - PHO(M1)
            ('M2', 'M3'): (50.0, 3.83),  # PHO(M2) - RS1(M3)
            ('M3', 'M4'): (150.0, 2.36), # RS1(M3) - RS2(M4)
            ('M3', 'M5'): ( 70.0, 2.11), # RS1(M3) - M05(M5)
    ...
    'NOS': {
        ...
        'dihedrals': {
            ...
            ('M1', 'C1', 'C3', 'C2'): (0.1, 1, 45.0),  # P1S - RS1 - M05 - RS2
            ('C1', 'C2', 'NA', 'NB'): (5.0, 1, 165.0),
            ('C2', 'NA', 'NB', 'NC'): (0.0, 1, 0.0),  # C2-NA-NB-NC
            ('NA', 'NB', 'ND', 'NC'): (80.0, 1, 0.0),  # NA-NB-ND-NC
            ('NA', 'NB', 'NC', 'ND'): (50.0, 1, 180.0),  # NA-NB-NC-ND
        },
        'impropers': {
            ('C1', 'M1', 'C2', 'C3'): (4.5, 0, -60.4),
            ('NA', 'C2', 'NB', 'ND'): (11.0, 0, -15.0),
        },
    },
    'C5P': {
        'bonds': {
    ...
    'HIC': {
        ...
        'dihedrals': {
            ('M1', 'M2', 'M3', 'M4'): (1.3, 1, -122.7),
            ('M2', 'M3', 'M5', 'M4'): (0.4, 2, -29.2),
        },
        'impropers': {},
    },
    'AD0': {
        ...
        'dihedrals': {
            ('NA', 'NB', 'NC', 'ND'): (80.0, 1, 180.0),
            ('NA', 'NB', 'ND', 'NC'): (50.0, 1,   0.0),
        },
        'impropers': {},
    },
    'GRS': {
    ...
    '4UO': {
        ...
        'angles': {
            ...
            ('C1', 'C2', 'NA'): (5.6, 141.4),
            ('NA', 'C2', 'C3'): (13.3, 133.0),
            ('C2', 'NA', 'NB'): (122.6, 127.1),
            ('C2', 'NA', 'ND'): (109.4, 118.0),
            ('NA', 'NB', 'NC'): (426.5, 90.8),
            ('NB', 'NC', 'ND'): (650.1, 84.5),
            ('NC', 'ND', 'NA'): (818.5, 72.6),
        },
        'dihedrals': {
            ('M1', 'C1', 'C2', 'NA'): (1.5, 1, 167.6),
            ('C1', 'C2', 'NA', 'NB'): (0.4, 2, -153.2),
        },
        'impropers': {
            ('C1', 'M1', 'C2', 'C3'): (1.9, 0, -51.5),
            ('NA', 'C2', 'NB', 'ND'): (3.7, 0, -8.9),
        },
    },
    'GUN': {
        'bonds': {
    ...
    'HYP': {
        ...
        'angles': {
            ('M1', 'M2', 'M3'): (105.0, 110.0),
            ('M1', 'M2', 'M4'): (93.0, 101.0),
        },
        'dihedrals': {
            ('M1', 'M2', 'M3', 'M4'): (25.9, 1, 7.0),
        },
        'impropers': {},
    },
    'ICO': {
        ...
        'angles': {
            ('M1', 'M2', 'M3'): (118.0, 147.0),
            ('M1', 'M2', 'M4'): (118.0, 150.0),
            ('M2', 'M4', 'M5'): (184.0, 111.0),
            ('M3', 'M4', 'M6'): (173.0, 127.0),
        },
        'dihedrals': {
            ('M1', 'M2', 'M3', 'M4'): (22.3, 1, -0.0),
            ('M1', 'M2', 'M4', 'M5'): (16.5, 1, -180.0),
            ('M2', 'M3', 'M4', 'M5'): (4.1, 1, 180.0),
            ('M2', 'M3', 'M4', 'M6'): (82.0, 1, -0.0),
            ('M3', 'M4', 'M5', 'M6'): (4.0, 1, -0.0),
        },
        'impropers': {},
    },
    'HFA': {
        ...
        'dihedrals': {
            ('M1', 'M2', 'M3', 'M4'): (1.4, 3, -48.0),
            ('M1', 'M2', 'M3', 'M5'): (1.1, 3, 120.0),
            ('M2', 'M3', 'M4', 'M5'): (1.1, 2, -21.0),
        },
        'impropers': {},
    },
    'MLA': {
    ...
    'FLN': {
        ...
        'angles': {
            ('M1', 'M3', 'M4'): (191.0, 147.0),
            ('M2', 'M3', 'M4'): (208.0, 87.0),
            ('M3', 'M4', 'M5'): (249.0, 93.0),
            ('M3', 'M4', 'M6'): (189.0, 148.0),
            ('M4', 'M6', 'M7'): (302.0, 115.0),
            ('M5', 'M6', 'M8'): (325.0, 106.0),
        },
        'dihedrals': {
            ('M1', 'M2', 'M3', 'M4'): (25.0, 1, 0.0),
            ('M2', 'M3', 'M4', 'M5'): (0.7, 2, -180.0),
            ('M2', 'M3', 'M4', 'M6'): (10.0, 1, 0.0),
            ('M3', 'M4', 'M5', 'M6'): (20.0, 1, 0.0),
            ('M3', 'M4', 'M6', 'M7'): ( 5.0, 1, 0.0),
            ('M4', 'M5', 'M6', 'M7'): (25.0, 1, 0.0),
            ('M4', 'M5', 'M6', 'M8'): (50.0, 1, 0.0),
        },
        'impropers': {},
    },
    'TRA': {
    ...
    'BTN': {
        ...
        'dihedrals': {
            ('M1', 'M2', 'M3', 'M4'): (0.2, 3, -102.0),
            ('M1', 'M2', 'M3', 'M5'): (0.4, 3, 88.0),
            ('M2', 'M3', 'M4', 'M5'): (5.0, 1, -3.0),
            ('M2', 'M3', 'M5', 'M6'): (7.3, 1, -96.0),
        },
        'impropers': {
            ('M5', 'M3', 'M4', 'M6'): (83.5, 0, 38.8),
        },
    },
    '1AL': {
        'bonds': {
    ...
    'PPY': {
        ...
        'dihedrals': {
            ('M1', 'M2', 'M3', 'M4'): (0.2, 2, -179.0),
            ('M1', 'M2', 'M3', 'M5'): (0.7, 2,  0.0),
            ('M2', 'M3', 'M4', 'M5'): (1.2, 3, -180.0),
        },
        'impropers': {},
    },
    'RBF': {
        ...
        'dihedrals': {
            ('M1', 'M2', 'M3', 'M4'): (0.7, 3, 33.0),
            ('M2', 'M3', 'M4', 'M5'): (10.4, 1, 101.0),
            ('M3', 'M4', 'M5', 'M6'): (2.7, 1, 70.0),
            ('M3', 'M4', 'M5', 'M10'): (2.6, 1, -112.0),
            ('M4', 'M5', 'M6', 'M7'): (17.3, 1, 26.0),
            ('M5', 'M6', 'M7', 'M8'): (355.8, 1, -180.0),
            ('M6', 'M5', 'M8', 'M10'): (54.8, 1, 1.0),
            ('M5', 'M10', 'M9', 'M8'): (155.6, 1, 180.0),
        },
        'impropers': {},
    },
    'DXC': {
        ...
        'angles': {
            ('M2', 'M3', 'M5'): (219.0, 95.0),
            ('M1', 'M3', 'M4'): (259.0, 81.0),
            ('M3', 'M5', 'M6'): (160.0, 121.0),
            ('M4', 'M5', 'M7'): (153.0, 123.0),
            ('M5', 'M7', 'M8'): (179.0, 116.0),
            ('M6', 'M7', 'M8'): (126.0, 120.0),
            ('M7', 'M8', 'M9'): (291.0, 85.0),
            ('M8', 'M9', 'M10'): (8.0, 102.0),
        },
        'dihedrals': {
            ('M3', 'M4', 'M5', 'M7'): (107.7, 1, -35.0),
            ('M3', 'M5', 'M6', 'M7'): (87.3, 1, -39.0),
            ('M4', 'M5', 'M7', 'M6'): (91.9, 1, -21.0),
            ('M4', 'M5', 'M7', 'M8'): (64.3, 1, -132.0),
            ('M5', 'M6', 'M7', 'M8'): (202.0, 1, -75.0),
            ('M5', 'M7', 'M8', 'M9'): (127.3, 1, -35.0),
            ('M6', 'M7', 'M8', 'M9'): (141.5, 1, -107.0),
            ('M7', 'M8', 'M9', 'M10'): (1.6, 1,  0.0),
        },
        'impropers': {},
    },
    'CHD': {
        ...
        'dihedrals': {
            ('M3', 'M4', 'M5', 'M7'): (131.8, 1, -30.0),
            ('M3', 'M5', 'M6', 'M7'): (92.2, 1, -43.0),
            ('M4', 'M5', 'M7', 'M6'): (81.0, 1, -41.0),
            ('M4', 'M5', 'M7', 'M8'): (60.2, 1, -152.0),
            ('M5', 'M6', 'M7', 'M8'): (199.7, 1, -74.0),
            ('M5', 'M7', 'M8', 'M9'): (130.4, 1, -35.0),
            ('M6', 'M7', 'M8', 'M9'): (143.4, 1, -106.0),
            ('M7', 'M8', 'M9', 'M10'): (1.6, 1,  0.0),
        },
        'impropers': {},
    },
    'VIB': {
        ...
        'dihedrals': {
            ('M1', 'M2', 'M3', 'M4'): (3.4, 1, -0.0),
            ('M2', 'M3', 'M4', 'M5'): (1.1, 2, 1.0),
            ('M2', 'M4', 'M5', 'M6'): (0.6, 3, -180.0),
            ('M2', 'M4', 'M5', 'M7'): (1.1, 1, -1.0),
            ('M4', 'M5', 'M7', 'M6'): (4.9, 1, 0.0),
        },
        'impropers': {},
    },
    'GNG': {
        ...
        'dihedrals': {
            ('M1', 'C1', 'C2', 'NA'): (1.8, 1, 163.0),
            ('C1', 'C2', 'NA', 'NB'): (1.2, 1, -143.0),
        },
        'impropers': {
            ('C1', 'M1', 'C2', 'C3'): (2.0, 0, -45.0),
            ('NA', 'C2', 'NB', 'ND'): (11.0, 0, -15.0),
        },
    },
    'DC': {
        ...
        'dihedrals': {
            ('M1', 'C1', 'C2', 'NA'): (8.7, 1, 161.0),
            ('C1', 'C2', 'NA', 'NB'): (2.7, 1, 42.0),
        },
        'impropers': {
            ('C1', 'M1', 'C2', 'C3'): (15.0, 0, -53.0),
        },
    },
    'G3P': {
        'bonds': {
    ...
    'D5M': {
        ...
        'dihedrals': {
            ('M1', 'C1', 'C2', 'NA'): (1.4, 1, -180.0),
            ('C1', 'C2', 'NA', 'NB'): (2.3, 1, -155.0),
        },
        'impropers': {
            ('C1', 'M1', 'C2', 'C3'): (21.0, 0, -49.0),
            ('NA', 'C2', 'NB', 'ND'): (12.0, 0, -14.0),
        },
    },
    '3D1': {
        'bonds': {
        ...
        'dihedrals': {
            ('M1', 'C1', 'C2', 'NA'): (2.1, 1, -166.0),
            ('C1', 'C2', 'NA', 'NB'): (2.1, 1, -152.0),
        },
        'impropers': {
            ('C1', 'M1', 'C2', 'C3'): ( 3.0, 0, -41.0),
            ('NA', 'C2', 'NB', 'ND'): (13.0, 0, -14.0),
        },
    },
    'ALY': {
        'bonds': {
    ...
    'XAN': {
        ...
        'dihedrals': {
            ('NA', 'NB', 'ND', 'NC'): (46.5, 1, 0.0),
            ('NA', 'NB', 'NC', 'ND'): (91.4, 1, -180.0),
        },
        'impropers': {},
    },
    'HPA': {
        ...
        'dihedrals': {
            ('NA', 'NB', 'ND', 'NC'): (70.0, 1, 0.0),
            ('NA', 'NB', 'NC', 'ND'): (150.0, 1, -180.0),
        },
        'impropers': {},
    },
}
